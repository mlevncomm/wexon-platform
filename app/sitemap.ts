...
const routes: Array<{ path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }> = [
  ...
  { path: "/products/wexon-core", priority: 0.7, changeFrequency: "monthly" },
  { path: "/packages", priority: 0.75, changeFrequency: "weekly" },
  { path: "/paketler", priority: 0.5, changeFrequency: "weekly" },
  { path: "/solutions", priority: 0.7, changeFrequency: "monthly" },
  { path: "/cozumler", priority: 0.5, changeFrequency: "monthly" },
  { path: "/about", priority: 0.6, changeFrequency: "monthly" },
  { path: "/contact", priority: 0.6, changeFrequency: "monthly" },
  { path: "/iletisim", priority: 0.6, changeFrequency: "monthly" },
  { path: "/book-demo", priority: 0.55, changeFrequency: "monthly" },
  { path: "/randevu-ai", priority: 0.6, changeFrequency: "monthly" },
