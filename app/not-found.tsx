...
export default function NotFoundPage() {
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_18%_12%,rgba(93,255,101,0.18),transparent_34%),radial-gradient(circle_at_82%_18%,rgba(20,184,166,0.12),transparent_30%),linear-gradient(180deg,#030712_0%,#07111f_48%,#050b16_100%)] px-4 py-6 text-white sm:px-6 lg:px-8">
      <div
      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-3rem)] w-full max-w-6xl items-center gap-8 lg:grid-cols-[minmax(0,1fr)_460px]">
          ...
          <span className="mb-5 flex w-fit rounded-full border border-emerald-400/30 bg-[#5dff65]/10 px-4 py-1.5 text-xs font-semibold text-emerald-300">
            Rota bulunamadı
              </span>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Link href={publicUrl("/")} className="inline-flex items-center justify-center rounded-full bg-[#5dff65] px-6 py-3 text-sm font-black text-white shadow-lg shadow-[#5dff65]/20 transition hover:bg-[#48e050]">
                  Ana sayfaya dön
                </Link>
        ...
        <div className="relative min-w-0">
          ...
          <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-white/[0.07] p-6 shadow-2xl shadow-slate-950/30 backdrop-blur sm:p-8">
            <div className="mb-6 flex items-center justify-between gap-4">
              ...
              <span className="rounded-full border border-emerald-400/30 bg-[#5dff65]/10 px-3 py-1 text-xs font-bold text-emerald-300">
                stable
              </span>
            </div>
            <div className="relative mb-8 rounded-[28px] border border-white/10 bg-slate-950/40 p-6 text-center">
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(93,255,101,0.22),transparent_55%)]" />
