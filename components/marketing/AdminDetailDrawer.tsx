...
export default function AdminDetailDrawer({
  ...
  children,
  footer,
  widthClassName = "w-full sm:w-[min(36rem,92vw)] xl:w-[38rem]",
  ...
  return createPortal(
    <div className="fixed inset-0 z-[70]" role="presentation">
      ...
      <div
        ...
        className={`absolute inset-y-0 right-0 flex h-[100dvh] max-h-[100dvh] flex-col border-l border-slate-200 bg-white shadow-2xl shadow-slate-900/20 ${widthClassName}`}
      >
