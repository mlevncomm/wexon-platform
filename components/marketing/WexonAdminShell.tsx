            ...
            <div className="w-full min-w-0 rounded-[24px] border border-slate-200 bg-white p-3 shadow-sm shadow-slate-200/70 lg:sticky lg:top-24 lg:rounded-[28px] lg:p-3.5">
              <div className="mb-3 flex items-center justify-between gap-3 rounded-2xl bg-slate-50 px-4 py-3 lg:mb-4">
                <div>
                  ...
                  {session?.email && <p className="mt-1 max-w-[190px] truncate text-xs font-semibold text-slate-500">{session.email}</p>}
                </div>
                <span className="hidden h-9 w-9 items-center justify-center rounded-2xl bg-slate-950 text-xs font-black text-emerald-300 lg:flex">
                  A
                </span>
              </div>
              <WexonAdminNav />
