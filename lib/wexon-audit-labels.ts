const ACTION_LABELS: Record<string, string> = {
  ...
  "wexpay.assist.payment_request.created": "Ödeme talebi oluşturuldu",
  "wexpay.assist.payment_request.acknowledged": "Ödeme talebi üstlenildi",
  "wexpay.assist.payment_request.released": "Ödeme talebi bırakıldı",
  "wexpay.assist.payment_request.resolved": "Ödeme talebi çözüldü",
  "wexpay.assist.payment_request.cancelled": "Ödeme talebi iptal edildi",
  "wexpay.assist.payment_request.expired": "Ödeme talebi süresi doldu",
  "wexpay.assist.waiter_call.created": "Garson çağrısı oluşturuldu",
  "wexpay.assist.waiter_call.cancelled": "Garson çağrısı iptal edildi",
  "wexpay.assist.waiter_call.expired": "Garson çağrısı süresi doldu",
