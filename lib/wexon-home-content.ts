...
// WexPay tier prices are rendered from the canonical catalog (see
// `lib/wexon-pricing.ts`). Enterprise stays quote-based for custom setups.
export const ENTERPRISE_PLAN: PricingPlan = {
  ...
  features: ["Özel entegrasyon", "SLA ve gelişmiş destek", "Tek seferlik lisans seçeneği", "Çoklu ürün erişimi"],
  cta: "Teklif Al",
};
