...
- Public QR checkout PayTR destekler (API katmanı): `POST/GET /api/wexpay/public/[qrCode]/checkout`. Müşteri QR UX bu PR’da checkout başlatmaz; ödeme talebi / garson akışı için `docs/qr-customer-order-plan.md`.
